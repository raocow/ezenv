# rigor: auto-activate the nearest .venv when you cd into a project.
#
...
#   source "$(brew --prefix)/share/rigor/autovenv.zsh"
...
add-zsh-hook chpwd _rigor_autovenv
_rigor_autovenv  # run once for the current directory
